...
const EditProjectModal = ({ isOpen, project, onClose, onSave }: EditProjectModalProps) => {
  ...
  useEffect(() => {
    if (project && isOpen) {
      ...
      setWeeklyReports(project.weeklyReports);
      // limpa campos de criação de membro/report
      setNewMemberName("");
      setNewMemberRole("");
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm">
      <div className="glass-card w-full max-w-3xl max-h-[90vh] overflow-y-auto p-6 animate-slide-in">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-bold text-foreground">Editar Projeto</h2>
        ...
        <div className="space-y-6">
          ...
          {/* Reports */}
          <section className="space-y-3">
            <h3 className="text-sm font-semibold text-foreground">Reports Semanais</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <div>
